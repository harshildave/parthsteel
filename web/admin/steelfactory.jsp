...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Steel Factory Pricing Form</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Please input the Factory pricing for steel below : 
                        </div>
...
Float twentyfive = Float.parseFloat(request.getParameter("25"));
 ...
 int x=st.executeUpdate("update steel_factory set 8mm='"+eight+"',10mm='"+ten+"',12mm='"+twelve+"',16mm='"+sixteen+"',20mm='"+twenty+"',25mm='"+twentyfive+"' where pid='"+company+"'"); 
 if(x == 1){
    out.println("<script>alert('Update sucessfull');</script>");
     out.println("<script>window.location='steelfactory.jsp';</script>");
 }       
