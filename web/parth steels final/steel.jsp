<%-- 
    Document   : steel
    Created on : 26 Apr, 2016, 6:17:47 PM
    Author     : Admin
--%>
...
<header id="header">
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand normal" href="index.html"><img src="./images/logo.png" alt="uniform" /></a>
        </div> 
        <nav class="collapse navbar-collapse navbar-right navbar-main-collapse">
            <ul id="nav" class="nav navbar-nav navigation">
                ...
                <li class="page-scroll menu-item"><a href="index.html#team">Team</a></li>
                <li class="page-scroll menu-item"><a href="index.html#company">About Us</a></li>
                <!--<li class="page-scroll menu-item menu-item-has-children">
                ...
                <li class="page-scroll menu-item"><a href="index.html#contact">contact</a></li>
        ...
        <article class="post">
            <div class="row">
                 <div class="col-sm-10 col-sm-offset-1 post-image">
                    <div class="generic-carousel" data-animation-out="slideOutRight" data-animation-in="slideInLeft" data-dots="false">
                        <div class="item">
                            <img src="./demo/learn-more/consulting/01.jpg" height="400" width="970" alt="" class="img-responsive" />
                        </div>
                        <div class="item">
                            <img src="./demo/learn-more/consulting/02.jpg" alt="" class="img-responsive" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1">
                    <h2 class="title fz26 upper">Parth Steels provides comprehensive construction management consulting services that provide the best results for your project.</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 post-content">
                    <div class="text">
                        <p> Our experts possess decades of engineering and construction experience and apply this knowledge to the everyday challenges that owners, contractors, engineers, and architects face throughout the construction process. Depending on your specific project needs and requirements, Parth Steels provides the following construction consulting services:-</p>
                        <p>1.Construction Management</p>
                        <p>2.Scheduling</p>
                        <p>3.Cost Estimating</p>
                        <p>Parth Steels is a consulting firm that provides professional services to companies within the Real Estate Industry.We aim to serve a wide range of industries and construction projects countrywide & globally. Parth Steels solves and simplifies complex problems to help our clients build projects with a peace of mind.</p>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-xs-4">
                        <a href="./index.html" class="social-icon"><i class="fa fa-twitter"></i></a>
                        <span class="social-count">1K+</span>
                    </div>
                    <div class="col-xs-4">
