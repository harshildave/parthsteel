...
String sql = "select `order`.* , reg.username , product.pname from `order` join reg on `order`.uid=reg.uid join product on `order`.pid=product.pid;";
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            int oid = rs.getInt(1);
                                            String unm = rs.getString(7);
                                            String pnm = rs.getString(8);
                                        ...
                                        <tr>
                                            <td><% out.println(oid);%></td>
                                            <td><% out.println(unm); %></td>
                                            <td><% out.println(pnm); %></td>
